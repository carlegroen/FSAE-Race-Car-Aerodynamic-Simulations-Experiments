...
\section{Results}
  ...
  The theoretical lift coefficient at of the scale wing using a total AOA of $\alpha = 35^\circ$, an effective additional AOA from the wing's camber of $\alpha_{L_0} = 0^\circ$ CITE SOMETHING HERE and equation \ref{eq:CL} is found to be:
  \begin{align*}
